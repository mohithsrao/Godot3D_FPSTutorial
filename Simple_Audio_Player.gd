...
var audio_pistol_shot = preload("res://Audio/gun_shot_01.wav")
var audio_gun_cock = preload("res://Audio/gun_load_01.wav")
var audio_rifle_shot = preload("res://Audio/gun_load_01.wav")
